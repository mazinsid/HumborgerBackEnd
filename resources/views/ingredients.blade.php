...
<body>
    ...
    <div id="myModal" class="modal">
      ...
      <div class="modal-content">
        ...
        <form enctype="multipart/form-data" role="form" method="POST" action="{{route('store_ingredient')}}">
          @csrf  
          ...
          <input name="folderName" value="{{$folderName}}" hidden>
          <div class="input-group">
    ...
    <table style="width: 100%">
        <tr>
          ...
          <tr>
            ...
            <td><img style="width: 40px " src="{{asset('storage/'.$ingredient->image)}}">{{$folderName}}</td>
          </tr>
          @endforeach
          </tbody>
    </table>
